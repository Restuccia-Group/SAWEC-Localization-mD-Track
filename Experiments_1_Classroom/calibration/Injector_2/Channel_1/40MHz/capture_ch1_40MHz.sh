...
for phy_id in $@
do
    sudo array_prepare_for_picoscenes $phy_id "5955 HT40+"
done
sleep 5

PicoScenes "-d debug; 
	-i $1 --preset RX_CBW_40 --source-address-filter 00:16:ea:12:34:56 --output $1 --mode logger;
	-i $2 --preset RX_CBW_40 --source-address-filter 00:16:ea:12:34:56 --output $2 --mode logger;
        -i $3 --preset RX_CBW_40 --source-address-filter 00:16:ea:12:34:56 --output $3 --mode logger;
        ...
        -i $4 --preset TX_CBW_40_HESU --txcm 1 --repeat 100000 --delay 5e3 --mode injector"
