...
from ../../Python_Estimators_new/utilityfunct_aoa_toa_doppler import build_aoa_matrix, build_toa_matrix
from ../../Python_Estimators_new/utilityfunct_md_track import md_track_2d
import matplotlib
...
if __name__ == '__main__':
    ...
    for time_idx in range(0, num_time_steps):
        ...
        plot_mdtrack_results(paths_amplitude_list[start_plot:end_plot], paths_toa_list[start_plot:end_plot],
                             paths_aoa_list[start_plot:end_plot], num_paths_plot)
