function [Vtilde1, Vtilde2] = beamformingFeedbackQuantizationComparison(V, Nr, Nc)
...
Vtilde1 = Vtilde * I_matrix;

% Vreconstruct1 = Vtilde * Dtilde;
...
%% reconstruct V tilde matrix 2
I_matrix = eye(Nr, Nc+1);
Vtilde = eye(Nr, Nr);
for i = 1:min(Nc, Nr-1)
    Vtilde = Vtilde * cell2mat(D_i_matrices(i));
    for l = i+1:Nr
