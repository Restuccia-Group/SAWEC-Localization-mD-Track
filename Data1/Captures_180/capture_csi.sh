...
for phy_id in $@
do
    sudo array_prepare_for_picoscenes $phy_id "5500 160 5570"
done
sleep 5

PicoScenes "-d debug; 
	-i $1 --preset RX_CBW_160 --rxcm 1 --source-address-filter 00:16:ea:12:34:56 --output $1 --mode logger;
	-i $2 --preset RX_CBW_160 --rxcm 1 --source-address-filter 00:16:ea:12:34:56 --output $2 --mode logger;
        -i $3 --preset RX_CBW_160 --rxcm 1 --source-address-filter 00:16:ea:12:34:56 --output $3 --mode logger;
        -i $4 --preset RX_CBW_160 --rxcm 1 --source-address-filter 00:16:ea:12:34:56 --output $4 --mode logger;
        -i $5 --preset RX_CBW_160 --rxcm 1 --source-address-filter 00:16:ea:12:34:56 --output $5 --mode logger;
        -i $6 --preset RX_CBW_160 --rxcm 1 --source-address-filter 00:16:ea:12:34:56 --output $6 --mode logger;
        ...
        -i ${15} --preset TX_CBW_160_HESU --txcm 1 --repeat 100000 --delay 10e3 --mode injector"
