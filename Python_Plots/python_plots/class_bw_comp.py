...
# ax.set_ylim(0, 160)
# ax.set_yticks([0, 50, 100, 150], [0, 50, 100, 150], fontsize=35)
#
# ax.legend([rects1, rects2], columns_as_bars, loc='upper left', ncol=2, fontsize=32, framealpha=0.0)
#
#
#
#
...
ax.set_xticks(x)
ax.set_xticklabels(rows_as_group, fontsize=35)
ax.set_ylim(0.1, 1000)  # Adjusted the lower limit to avoid issues with log scale
ax.set_yscale('log')  # Set y-axis to a logarithmic scale
ax.set_yticks([0.1, 1, 10, 100], [0.1, 1, 10, 100], fontsize=35)  # Adjusted the y-axis ticks for log scale
